...
const Contact = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Contact Us - Blogzy</title>
        <meta name="description" content="Get in touch with the Blogzy team." />
      </Helmet>
          ...
          <div className="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-3">
            <div>
              ...
              <p className="mt-4 text-base leading-7 text-gray-600">
                Fill out the form and we'll get back to you as soon as possible. We value your feedback and are always looking for ways to improve Blogzy.
              </p>
              ...
              <div className="mt-8 space-y-6">
                <div className="flex gap-x-4">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-gray-600">support@blogzy.example.com</p>
                  </div>
                </div>
